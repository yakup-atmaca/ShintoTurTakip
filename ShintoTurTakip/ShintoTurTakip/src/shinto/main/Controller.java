...
public class Controller {
    ...
    private void configureView() {
        ...
        tabContainer.setTabMinHeight(125.0);
        tabContainer.setTabMaxHeight(125.0);
        ...
        configureTab(biletGirisiTab, "Bilet Satış", "/shinto/res/ticket7.png", biletGirisiContainer, getClass().getResource("/shinto/biletgirisi/BiletGirisi.fxml"), replaceBackgroundColorHandler);
        ...
        configureTab(ucakBiletiTab, "Uçak Bileti", "/shinto/res/ticket7.png", personelContainer, getClass().getResource("/shinto/personel/Personel.fxml"), replaceBackgroundColorHandler);
        configureTab(cariHesaplarTab, "Cari Hesaplar", "/shinto/res/cariHesap2.png", cariHesaplarContainer, getClass().getResource("/shinto/carihesaplar/CariHesaplar.fxml"), replaceBackgroundColorHandler);
        ...
        logoTab.setStyle("-fx-background-color: -fx-focus-color;");
    }
